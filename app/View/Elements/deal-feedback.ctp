                ...
                <div class="conversation-wrapper">
                    <div class="conversation-content">
                        ...
                        <div class="conversation-new-message discuss-add">
                            ...
                            <?php echo $this->Form->input('Discussion.type',array('type' => 'hidden','value' => 2) ); ?>
                            ...
                            <div class="conversation-inner">
                                ...
                                <div class="discussion-row" id="<?php echo 'row' . h($row['Discussion']['id']); ?>">
                                    ...
                                    <div class="discuss-actions">
                                        ...
                                        <a class="table-link danger pull-right" href="#" data-toggle="modal" data-target="#delM"  data-title="Delete Customer Feedback" data-action="discussions" data-id="<?= h($row['Discussion']['id']); ?>"><i class="fa fa-trash-o"></i></a>
                                            <?php endif; ?>
                                    </div>

                                    <div class="conversation-new-message discuss-reply discuss-reply-<?php echo h($row['Discussion']['id']); ?>" >
                                            <?php echo $this->Form->create('Discussion', array('url' => array('controller' => 'Discussions', 'action' => 'add', h($deal['Deal']['id'])), 'class' => 'vForm1')); ?>	
                                    ...
                                    <div id="<?php echo 'row' . h($row['Discussion']['id']); ?>">
                                        <div class="conversation-item  clearfix discuss-reply-message">
                                            ...
                                            <div class="conversation-body">
                                                ...
                                                <?php if ($this->Common->isAdmin()): ?>
                                        <div class="discuss-actions">                                          
                                            <a class="table-link danger pull-right" href="#" data-toggle="modal" data-target="#delM"  data-title="Delete Discussion" data-action="discussions" data-id="<?= h($row['Discussion']['id']); ?>"><i class="fa fa-trash-o"></i></a>
                                        </div>
                                                <?php endif; ?>
                                    </div>
                                            <?php
