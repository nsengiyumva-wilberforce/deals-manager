    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse sidebar-navbar-collapse">
            <ul class="nav navbar-nav">        
                ...
                <li class="<?= ($this->params['controller'] == 'settings' && ($this->params['action'] == 'backup')) ? 'active' : '' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'settings', 'action' => 'product_categories')); ?>"><span class="badge"><i class="fa fa-bars"></i></span> <?php echo __('Products Category'); ?></a></li>
                <li class="<?= ($this->params['controller'] == 'settings' && ($this->params['action'] == 'backup')) ? 'active' : '' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'settings', 'action' => 'brand_categories')); ?>"><span class="badge"><i class="fa fa-certificate"></i></span> <?php echo __('Products Brand'); ?></a></li>
                <li class="<?= ($this->params['controller'] == 'settings' && ($this->params['action'] == 'backup')) ? 'active' : '' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'settings', 'action' => 'unit_categories')); ?>"><span class="badge"><i class="fa fa-code"></i></span> <?php echo __('Products Unit'); ?></a></li>
                <li class="<?= ($this->params['controller'] == 'settings' && ($this->params['action'] == 'backup')) ? 'active' : '' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'settings', 'action' => 'issuance_categories')); ?>"><span class="badge"><i class="fa fa-hand-grab-o"></i></span> <?php echo __('Products Issuance'); ?></a></li>
