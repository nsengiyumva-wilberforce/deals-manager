    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $this->Form->create('Brand', array('url' => array('controller' => 'products', 'action' => 'brands'), 'inputDefaults' => array('label' => false, 'div' => false), 'class' => 'vForm1')); ?>
...
<div class="modal fade" id="delM">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create('Brand', array('url' => array('action' => 'remove'))); ?>
