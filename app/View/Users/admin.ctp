<?php
/**
 * View for all admin list in application .
 * 
 * @author:   AnkkSoft.com
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('Add Admin'); ?></h4>
            </div>
            <div class="modal-body">
                ...
                <?php echo $this->Form->input('user_group_id', array('type' => 'hidden', 'value' => '1')); ?>
...
<div class="row">											
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                <div class="clearfix">
                    <h1 class="pull-left"><?php echo __('Admins'); ?></h1>
                    <div class="pull-right top-page-ui">                      
                        <a class="btn btn-primary pull-right" href="#" data-toggle="modal" data-target="#staffModal">
                            <i class="fa fa-plus-circle fa-lg"></i> <?php echo __('Add Admin'); ?>
                        </a>
