...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                <div class="clearfix">
                    <h1 class="pull-left"><?php echo __('Import Companies'); ?></h1>               
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box no-header clearfix">					  
                    <div class="main-box-body clearfix">
                        ...
                        <?php echo $this->Form->create('Company', array('type' => 'file', 'url' => array('controller' => 'companies', 'action' => 'import'), 'inputDefaults' => array('label' => false, 'div' => false))); ?>
                        <div class="form-group">
                            <?php echo $this->Form->input('Company.csv_file', array('type' => 'file', 'class' => 'btn btn-primary', 'label' => false)); ?>
                        </div>
                        <div class="form-group">
